...
{
    public class GetDatosPrincipalesHandler : IRequestHandler<GetDatosPrincipalesQuery, Result<DatosPrincipalesSunat>>
    {
        ...
        public GetDatosPrincipalesHandler(
        ...
        public async Task<Result<DatosPrincipalesSunat>> Handle(GetDatosPrincipalesQuery request, CancellationToken cancellationToken)
        {
            int idplicacion = 0;
            ...
            var resultado = _sunat.GetDatosPrincipales(_configuration["Servicios:Sunat:Ruta"].ToString(), request.nroRuc);
            ...
            return new Result<DatosPrincipalesSunat>(true, resultado);
        }
    }
}
