...
{
    public class GetDomicilioLegalHandler : IRequestHandler<GetDomicilioLegalQuery, Result<DomicilioLegalSunat>>
    {
        ...
        public GetDomicilioLegalHandler(
        ...
        public async Task<Result<DomicilioLegalSunat>> Handle(GetDomicilioLegalQuery request, CancellationToken cancellationToken)
        {
            int idplicacion = 0;
            ...
            var resultado = _sunat.GetDomicilioLegal(_configuration["Servicios:Sunat:Ruta"].ToString(), request.nroRuc);
            ...
            return new Result<DomicilioLegalSunat>(true, resultado);
        }
    }
}
